...
const TermOfServicePage = props => (

    <React.Fragment>
        <main>
            <hr /> 
            <p>非常歡迎您光臨「MorrisCTech餐點訂購網」（以下簡稱本網站），為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：</p>
            
            <h3>
                <a
                    id="user-content-一隱私權保護政策的適用範圍-1"
                    className="anchor"
                    aria-hidden="true"
                    href="#一隱私權保護政策的適用範圍-1">
                    <svg
            ...
            <h3>
                <a
                    id="user-content-二個人資料的蒐集處理及利用方式-1"
                    className="anchor"
                    aria-hidden="true"
                    href="#二個人資料的蒐集處理及利用方式-1">
                    <svg
                        className="octicon octicon-link"
                        viewBox="0 0 16 16"
                        version="1.1"
            ...
            <h3>
                <a
                    id="user-content-五與第三人共用個人資料之政策-1"
                    className="anchor"
                    aria-hidden="true"
                    href="#五與第三人共用個人資料之政策-1">
                    <svg
                        className="octicon octicon-link"
                        viewBox="0 0 16 16"
                        version="1.1"
